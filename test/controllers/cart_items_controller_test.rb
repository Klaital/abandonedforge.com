...
class CartItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cart_item" do
    assert_difference('CartItem.count') do
      post cart_items_url, params: { cart_item: { comments: @cart_item.comments, price: @cart_item.price, qty: @cart_item.qty } }
    end
  ...
  test "should update cart_item" do
    patch cart_item_url(@cart_item), params: { cart_item: { comments: @cart_item.comments, price: @cart_item.price, qty: @cart_item.qty } }
